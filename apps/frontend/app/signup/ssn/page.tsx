        ...
        <div className="flex w-full flex-col gap-[10px] pt-[32px]">
          <div className="flex w-full gap-[10px]">
            <input
              ...
              placeholder="앞자리"
              className="flex-1 rounded-[16px] border border-[#e5e8ef] bg-white p-[20px] text-[18px] font-medium leading-[26px] text-[#191f28] placeholder:text-[#b0b8c1] focus:outline-none"
            />
            <input
              inputMode="numeric"
              maxLength={7}
